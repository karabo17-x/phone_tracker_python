...
class PhoneTrackerCLI:
    ...
    def display_results(self, phone_number: str, number_type: str, provider_info: dict, 
        ...
        print(f"\n{self.formatter.bold('SYSTEM LIMITATIONS')}")
        print(f"No real-time tracking")
        print(f"No access to private telecom databases")
        print(f"Location inference based on public prefix allocations")
        print(f"Activity status cannot be verified without carrier API access")
        print(f"All geographic data marked as ESTIMATED")
